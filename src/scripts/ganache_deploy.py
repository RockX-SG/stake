...
def main():
    ...
    transparent_staking.pushBeacon(1, '32.1 ethers', transparent_staking.getVectorClock(), {'from':owner})
    ...
    transparent_staking.pushBeacon(0, 0,transparent_staking.getVectorClock() , {'from':owner})
