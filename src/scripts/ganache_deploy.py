...
def main():
    ...
    transparent_staking.pushBeacon(1, '32.1 ethers', vectorClock, {'from':owner})
    print("redeem 32 ether")
    transparent_staking.redeemFromValidators('32 ethers', '33 ethers', time.time() + 600, {'from':owner})
    accounts[0].transfer(transparent_staking.address, '32.2 ethers')
    vectorClock = transparent_staking.getVectorClock()
    print("vector clock:", vectorClock)
    transparent_staking.validatorStopped([0x97d717d346868b9df4851684d5219f4deb4c7388ee1454c9b46837d29b40150ceeb5825d791f993b03745427b6cbe6db],'32.1 ethers', vectorClock, {'from':accounts[0]})
