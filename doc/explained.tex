...
\begin{figure}
\begin{center}
    \smartdiagram[circular diagram:clockwise]{register validators, mint, delegation, redeem, push rewards, validators exit}
\end{center}
...
\begin{description}
   ...
   \item[Qualified Validators Registration] to vote on validator keys proposed by other institutions, or to remove a validator.
	\item[Granting Roles] to vote to grant specific roles to account addresses, like: \textbf{ORACLE\_ROLE, REGISTRY\_ROLE, MANAGER\_ROLE, PAUSER\_ROLE} 
