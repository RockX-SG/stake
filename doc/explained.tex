...
Ethers moves from contract to validators, or vice versa, we can assume: \textbf{RecentEthersMoved} is the ethers moved between ${validators}\Longrightarrow{contract}$.
...
\subsection{Understanding rewards by balance sheet}
\begin{table}[!ht]
    \centering
